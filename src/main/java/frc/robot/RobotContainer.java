...
public class RobotContainer {
  ...
  // Yteam Autonumus Chooser
  // public final AutoGenerator[] autoCommands =  {ExampleAutoCommand exampleAutoCommand};
  // public final AutoChooser autoChooser = new AutoChooser(m_autoCommand, autoCommands);
  ...
  private void configureButtonBindings() {
    // Yteam loadButtons
    robotButtons.loadButtons(m_exampleSubsystem);
  }
